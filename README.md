...
3. ** AI-Assisted Health Analysis** — browser-side baseline-deviation logic with live input validation, monitoring status (NORMAL / MODERATE ATTENTION / HIGH ATTENTION), detected factors, explanation, and suggested actions
